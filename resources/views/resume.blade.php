...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="h-screen w-full flex justify-center items-center bg-gradient-to-br from-blue-300">
            <div>
                <h2 class="text-xl text-stone-700 mb-5">Timeline of my work!</h2>
                ...
                <a href="pdf/freshcat2.pdf" download="freshcat2.pdf">
                    ...
                    <div class="flex justify-left">
                        <div class="justify-center mt-16 px-0 sm:items-center sm:justify-between">
                            <button type="button" class="text-black font-bold py-2 px-4 rounded bg-gradient-to-r from-emerald-300 to-sky-200 hover:from-rose-600 hover:to-yellow-200 ">
