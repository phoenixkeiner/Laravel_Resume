...
<body
    class="antialiased w-full flex justify-center selection:bg-fuchsia-300 selection:text-fuchsia-900
    ...
    <div role="resume list" class="mx-auto p-6 lg:p-8">
        ...
        <ol class="relative border-l border-stone-200 dark:border-stone-700 py-4">
            ...
            <li class="mb-10 ml-4">
                ...
                <time class="mb-1 text-sm font-normal leading-none text-stone-400 dark:text-stone-500">August 2018 -
                    June 2020</time>
        ...
        <a href="pdf/resume.pdf" download="resume.pdf">
            <button
                class="inline-flex items-center px-4 py-2 text-sm font-medium text-stone-900 bg-white border border-stone-200 rounded-lg hover:bg-stone-100 hover:text-blue-700 focus:z-10
