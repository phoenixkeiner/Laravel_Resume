...
<!-- pulls code from header file -->

<title>Too Much Information About Phoenix</title>

<body
    class="antialiased selection:text-fuchsia-900 selection:bg-cyan-200
    ...
    <div>
        <div class="mx-auto p-6 lg:p-8">
            <div class="rounded overflow-hidden w-full justify-center">
                <h1
                    class="mb-4 text-4xl text-center font-extrabold leading-none tracking-tight text-white md:text-5xl lg:text-6xl dark:text-stone-900">
                    Too Much Information About Phoenix!</h1>

                <hr class="w-72 h-1 mx-auto my-4 bg-stone-300 border-0 rounded md:my-10 dark:bg-stone-700">

                <h1
                    class="mb-4 text-xl text-center font-extrabold leading-none tracking-tight text-white md:text-4xl lg:text-5xl dark:text-stone-900">
                ...
                <div class="flex items-center justify-center">
                    <blockquote class="instagram-media" data-instgrm-captioned
                        data-instgrm-permalink="https://www.instagram.com/p/Cpa9RB4u8I0/?utm_source=ig_embed&amp;utm_campaign=loading"
                        ...
                        <div style="padding:16px;"> <a
                                href="https://www.instagram.com/p/Cpa9RB4u8I0/?utm_source=ig_embed&amp;utm_campaign=loading"
                            ...
                            <p
                                ...
                                <a href="https://www.instagram.com/p/Cpa9RB4u8I0/?utm_source=ig_embed&amp;utm_campaign=loading"
                                    style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;"
                                    target="_blank">A post shared by Phoenix Keiner (@phoenixxkeinerr)</a>
                            </p>
                        </div>
                    </blockquote>
            ...
            <h1 class="mb-4 text-center text-3xl font-extrabold text-stone-900 dark:text-white md:text-5xl lg:text-6xl">
                <span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Pictures of my
                    cats: Luz and Riley!</span>
            </h1>
            ...
            <div class="inline-flex items-center justify-center w-full">
                ...
                <div class="absolute px-4 -translate-x-1/2 left-1/2">
                    <svg aria-hidden="true" class="w-5 h-5 text-stone-700 dark:text-stone-300" viewBox="0 0 24 27"
            ...
            <div class="max-w-screen-md  items-center justify-center">
                <div class="flex items-center">
                    ...
                    <svg aria-hidden="true" class="w-5 h-5 text-stone-300 dark:text-stone-500" fill="currentColor"
